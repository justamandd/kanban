                ...
                <div class="card text-center">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <input type="text" name="username" id="username" placeholder="Usuário" class="form-control form-control-lg" value="<?php echo isset($usuario)?$usuario->getLogin():'' ?>" required>
                        </div>
                        ...
                        <!-- Password -->
                        <div class="form-group">
                            <input type="password" name="password" id="password" placeholder="Senha" class="form-control form-control-lg" value="<?php echo isset($usuario)?$usuario->getPassword():'' ?>" required>
                        </div>
